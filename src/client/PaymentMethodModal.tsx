      ...
      <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-200 w-full max-w-lg overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-deep-black">Payment Methods Coming Soon</h2>
              <p className="text-xs text-gray-500">Secure Billing</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-8">
          <p className="text-sm text-gray-500 mb-6 leading-relaxed">
            We&apos;re currently integrating secure payment methods with Stripe. Soon you&apos;ll be able to
            securely add and manage your payment methods directly from your dashboard.
          </p>

          {/* Features Coming Soon Info Box */}
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 mb-8">
            <h3 className="text-sm font-semibold text-deep-black mb-3">Features coming soon:</h3>
