...
export default function RecentPosts({ articles }: { articles: Article[] }) {
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6">
      <div className="flex items-center gap-3 mb-5">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-royal-blue/[0.06]">
          <ArrowRight className="h-4.5 w-4.5 text-royal-blue" />
        </div>
        <h3 className="text-base font-semibold text-deep-black">Recent Posts</h3>
      </div>
